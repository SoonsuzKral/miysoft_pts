<?php
// Generated by Cursor prompt — module: Finans (ExpenseRequest) — date: 2026-03-15
...
class ExpenseRequest extends Model
{
    ...
    public function approve(int $approverId): array
    {
        ...
        return ['success' => true, 'message' => 'Masraf talebi onaylandı.'];
    }
    ...
    public function markPaid(int $userId): array
    {
        if ($this->status !== self::STATUS_APPROVED) {
            return ['success' => false, 'message' => 'Sadece onaylı talepler ödenmiş olarak işaretlenebilir.'];
        }
        $this->update(['status' => self::STATUS_PAID]);
        return ['success' => true, 'message' => 'Masraf ödemesi kaydedildi.'];
    }
