<?php
// Generated by Cursor prompt — module: Finans (AdvanceController) — date: 2026-03-15
...
class AdvanceController extends Controller
{
    ...
    public function create(): JsonResponse
    {
        ...
        $personels = \App\Modules\Personel\Models\Personel::forCompany($companyId)->active()
            ->select('id', 'first_name', 'last_name')->get();
        return response()->json(['html' => view('admin.finances.advances._form', compact('personels'))->render()]);
    }
