            ...
            <div>
                <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 mb-8">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        {{ $contact['address'] ?? 'MİYSOFT Teknoloji A.Ş.' }}<br>
                        {{ $contact['city'] ?? 'İstanbul' }}<br>
                        {{ $contact['country'] ?? 'Türkiye' }}
                    </p>
                </div>
                <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 mb-8">
                    <h3 class="text-xl font-black text-gray-900 mb-6 flex items-center gap-2">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-center gap-2 text-gray-600">
                            ...
                            {{ $contact['email'] ?? 'info@miysoft.com.tr' }}
                        </li>
                        <li class="flex items-center gap-2 text-gray-600">
                ...
                @if(isset($contact['map_embed']))
                <div class="rounded-3xl overflow-hidden border border-gray-100 shadow-xl">
                    {!! $contact['map_embed'] !!}
                </div>
                @else
