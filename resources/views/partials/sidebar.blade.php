...
<aside id="admin-sidebar">
    ...
    <nav class="pts-nav">
        ...
        {{-- ─── LOKASYON ─── --}}
        <div class="pts-nav-divider"></div>
        <p class="pts-nav-section">Lokasyon</p>

        @can('location.view')
        <a href="{{ route('admin.lokasyon.index') }}" class="pts-nav-link {{ $on('admin.lokasyon') ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <span>Lokasyonlar</span><span class="pts-dot"></span>
        </a>
        @endcan

        @can('special-hour.view')
        <a href="{{ route('admin.special-hour.index') }}" class="pts-nav-link {{ $on('admin.ozel-saat') ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
            <span>Özel Saat</span><span class="pts-dot"></span>
        </a>
        @endcan
        ...
        {{-- Dökümantasyon --}}
        <a href="{{ route('admin.dokumantasyon.page') }}" class="pts-nav-link {{ request()->routeIs('admin.dokumantasyon*') ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
            </svg>
            <span>Dökümantasyon</span><span class="pts-dot"></span>
        </a>
