<?php
// Generated by Cursor prompt — module: Finans (ExpenseController) — date: 2026-03-15
...
class ExpenseController extends Controller
{
    ...
    public function create(): JsonResponse
    {
        ...
        $personels  = \App\Modules\Personel\Models\Personel::forCompany($companyId)->active()
            ->select('id', 'first_name', 'last_name')->get();
        $categories = ExpenseCategory::forCompany($companyId)->active()->get();
        return response()->json(['html' => view('admin.finances.expenses._form', compact('personels', 'categories'))->render()]);
    }
    ...
    /** Makbuz/fiş görüntüle */
    public function viewAttachment(ExpenseRequest $expense, int $index): \Symfony\Component\HttpFoundation\StreamedResponse
    {
        $this->authorize('expense.view');
