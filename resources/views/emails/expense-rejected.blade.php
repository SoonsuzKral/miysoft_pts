...
.badge { display: inline-block; background: #fef2f2; color: #dc2626; padding: 6px 16px; border-radius: 99px; font-size: 13px; font-weight: 700; margin-bottom: 20px; }
...
.reason-box { background: #fef2f2; border: 1px solid #fecaca; border-radius: 12px; padding: 16px 20px; margin: 20px 0; color: #991b1b; font-size: 14px; line-height: 1.6; }
...
<div class="container">
    <div class="header">
        <h1>❌ Masraf Talebiniz Reddedildi</h1>
    ...
    <div class="body">
        ...
        <p style="color:#6b7280;font-size:14px;line-height:1.6;">Masraf talebiniz reddedilmiştir. Detaylar aşağıda yer almaktadır.</p>
        ...
        <div class="info-box">
            ...
            <div class="info-row">
                <span class="info-label">Reddeden</span>
                <span class="info-value">{{ $rejectorName }}</span>
            </div>
        </div>

        <div class="reason-box">
            <strong>Reddetme Nedeni:</strong><br>
            {{ $reason }}
        </div>

        <a href="{{ config('app.url') }}/admin/expenses" class="btn">Sistemi Görüntüle →</a>
